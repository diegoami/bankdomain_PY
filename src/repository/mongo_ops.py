...
class MongoRepository:
    ...
    def print_all_files(self):
        with open('data/questions.txt', 'w') as f:
            f.writelines(self.iterate_questions(collection=self.questions, separator=True))

        with open('data/preprocessed_questions.txt', 'w') as f:
            f.writelines(
                self.iterate_questions(collection=self.preprocessed_questions, separator=True))

        with open('data/processed_questions.txt', 'w') as f:
            f.writelines(
                self.iterate_questions(collection=self.processed_questions, separator=True))
