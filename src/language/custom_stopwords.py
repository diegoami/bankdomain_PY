CUSTOM_STOP_WORDS  = set("""
 --
 1 2 3 4 5
 above aufgrund and auf Auf at At aufs als Als am Am
 ...
 dabei Dabei damit Damit dazu Dazu danach Danach dort Dort
 ...
 sobald sodass sofern sogar solange somit soweit stattdessen seit Seit s Sie sie sofern Sofern sollte Sollte
 t
 u. über Über
 unten Unten
 x
